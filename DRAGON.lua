...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MahmoudM5/leader/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1751198705,1593178008,4,44}   
...
elseif tonumber(user_id) == tonumber(44) then
var = 'مطور السورس'  
elseif tonumber(user_id) == tonumber(1766136507) then
var = 'مطور السورس'  
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then 
...
os.execute('wget https://raw.githubusercontent.com/MahmoudM5/leader/main/DRAGON.lua')
...
if text == 'مبرمج اسلام' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مبرمج اسلام', url="t.me/C_V205"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MahmoudM5/leader/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MahmoudM5/leader/main/File_Bot/"..file)
if res == 200 then
